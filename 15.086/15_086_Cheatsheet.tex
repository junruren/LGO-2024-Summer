...
\Hint{
    \begin{itemize}
        ...
        \item Correlation is guaranteed to lie between $+1$ (perfect positive correlation) and $-1$ (perfect negative
            correlation). Hence Corr is more commonly used than Covariance.
    \end{itemize}
}
\includegraphics[width=0.24\textwidth]{correlation_examples.png}
